...
/*******************************************************************
 * Enum: 20100627_enum.proto, line 4
 *******************************************************************/
int st_write_with_tag(enum st *_st, void *_buffer, int offset, int tag) {
    /* Write tag.*/
    offset = write_raw_varint32((tag<<3)+0, _buffer, offset);
    /* Write content.*/
    offset = write_raw_varint32(*_st, _buffer, offset);
    
    return offset;
}

/*******************************************************************
 * Message: 20100627_enum.proto, line 8
 *******************************************************************/
int Heartbeat_write(struct Heartbeat *_Heartbeat, void *_buffer, int offset) {
    /* Write content of each message element.*/
    offset = st_write_with_tag(&_Heartbeat->_stat, _buffer, offset, 1);
...
int Heartbeat_write_with_tag(struct Heartbeat *_Heartbeat, void *_buffer, int offset, int tag) {
    ...
    /* Write content.*/
    offset = Heartbeat_write_delimited_to(_Heartbeat, _buffer, offset);
...
int Heartbeat_write_delimited_to(struct Heartbeat *_Heartbeat, void *_buffer, int offset) {
    ...
    new_offset = Heartbeat_write(_Heartbeat, _buffer, offset);
...
void Heartbeat_clear(struct Heartbeat *_Heartbeat) {
    _memset(_Heartbeat, 0, sizeof(struct Heartbeat));
}

int Heartbeat_read(void *_buffer, struct Heartbeat *_Heartbeat, int offset, int limit) {
    int i = 0;
    unsigned long tag = i;

    /* Reset all attributes to 0 in advance. */
    Heartbeat_clear(_Heartbeat);
    ...
    while(offset < limit) {
        ...
        tag = tag>>3;
        switch(tag){
            //tag of: _Heartbeat._stat 
            case 1 :
                offset = read_raw_varint32(&tag, _buffer, offset);
                _Heartbeat->_stat = tag;
                break;
        }
    }
...
int Heartbeat_read_delimited_from(void *_buffer, struct Heartbeat *_Heartbeat, int offset) {
    ...
    offset = read_raw_varint32(&size, _buffer, offset);
    Heartbeat_read(_buffer, _Heartbeat, offset, size + offset);
