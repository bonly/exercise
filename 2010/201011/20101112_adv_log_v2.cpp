...
//#include <boost/log/expressions.hpp>  /// v1中没有这文件 
#include <boost/log/attributes.hpp>
#include <boost/log/sinks.hpp>
//#include <boost/log/sources/logger.hpp>  ///v1 中没有
#include <boost/log/utility/empty_deleter.hpp>
//#include <boost/log/utility/manipulators/add_attr.hpp>  ///v1 中没有
//#include <boost/log/attributes/scoped_attribute.hpp>  ///v2
#include <boost/log/utility/scoped_attribute.hpp>   ///v1
//#include <boost/log/support/date_time.hpp>  ///v1中没有
...
int main(int argc, char* argv[])
{
    ...
    shared_ptr<file_sink> fsink(boost::make_shared<file_sink>( keywords::file_name="%Y%m%d_%H%M%S_%5N.log",
        keywords::rotation_size=16384 
    ));
    // 旧写法:日志文件1个小时换一个,大小不超过1M,文件名从file_00.log开始
    //pSink->locked_backend()->add_steam(boost::make_shared<boost::log::rotating_ofstream>("file_%02N.log", 
    //   boost::log::keywords::rotation_interval=3600, boost::log::keywords::rotation_size=1048576));
...
*/
    ...
    logging::core::get()->add_global_attribute("FileLine", formatter::tag::file_line());
