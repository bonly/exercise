...
TThostFtdcInvestorIDType INVESTOR_ID = "017436";			// 投资者代码
TThostFtdcPasswordType  PASSWORD = "hay111";			// 用户密码
char *ppInstrumentID[] = {"A01608"};
//{"TA509","SR509"};//,"IF1506","cu1205", "cu1206"};			// 行情订阅列表
