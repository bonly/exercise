...
INC=/home/opt/mpich/include /home/bonly/luabind /home/bonly/lua/include /home/bonly/boost /home/bonly/luawrapper
...
$(EXE): $(SOURCES)
	$(CXX) $(addprefix -I, $(INC)) $(addprefix -l, $(LIBS)) $(CXXFLAGS) $^ -o $@ $(LIBPATH_BOOST) $(addprefix -L, $(LIBPATH)) /home/bonly/lua/lib/liblua.a
	mv $(EXE) Debug
