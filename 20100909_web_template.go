  ...
  `
	...
	for _, row := range rows {
		...
		case 0:
			...
			break;
		case 1:
			sh.D级别10_19 = row.Int(1);
			break;
		case 2:
			sh.D级别20_29 = row.Int(1);
			break;
		case 3:
			sh.D级别30_39 = row.Int(1);
			break;
		case 4:
			sh.D级别40_49 = row.Int(1);
			break;
    case 5:
			sh.D级别50_59 = row.Int(1);
			break;
    case 6:
			sh.D级别60_69 = row.Int(1);
			break;
    case 7:
			sh.D级别70_79 = row.Int(1);
			break;
    case 8:
			sh.D级别80_89 = row.Int(1);
			break;
    case 9:
			sh.D级别90_99 = row.Int(1);
			break;
    case 10:
			sh.D级别100_109 += row.Int(1);
			break;					
		}
	}
	return
