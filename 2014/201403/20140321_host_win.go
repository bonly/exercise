...
func main(){
	fl, err := os.OpenFile(os.Getenv("windir") + "\\System32\\Drivers\\etc\\hosts", os.O_RDWR|os.O_TRUNC|os.O_CREATE, 0666);
	if err != nil{
...
/*
CGO_ENABLED=0 GOOS=windows go build 20140321_host_win.go
*/
