...
$packages["main"] = (function() {
	...
	DigitalRain.ptr.prototype.dropWaterAtCol = function(col, speed, length, start, created) {
		...
		while (true) {
			if (!(i < length)) { break; }
			(x = wd.glyphs, ((i < 0 || i >= x.$length) ? $throwRuntimeError("index out of range") : x.$array[x.$offset + i] = (_r = randi() % 80, _r === _r ? _r : $throwRuntimeError("integer divide by zero"))));
			i = i + (1) >> 0;
		}
		...
		while (true) {
			...
			while (true) {
				...
				if ((_r$2 = ri$1 % 50, _r$2 === _r$2 ? _r$2 : $throwRuntimeError("integer divide by zero")) === 0) {
					glyph = (_r$3 = ri$1 % 80, _r$3 === _r$3 ? _r$3 : $throwRuntimeError("integer divide by zero"));
	...
	DigitalRain.init("main", [{prop: "parent", name: "parent", exported: false, typ: ptrType$3, tag: ""}, {prop: "canvas", name: "canvas", exported: false, typ: ptrType$3, tag: ""}, {prop: "ctx", name: "ctx", exported: false, typ: ptrType$3, tag: ""}, {prop: "width", name: "width", exported: false, typ: $Float64, tag: ""}, {prop: "height", name: "height", exported: false, typ: $Float64, tag: ""}, {prop: "ratio", name: "ratio", exported: false, typ: $Float64, tag: ""}, {prop: "timestamp", name: "timestamp", exported: false, typ: Duration, tag: ""}, {prop: "lowGlyphCanvas", name: "lowGlyphCanvas", exported: false, typ: ptrType, tag: ""}, {prop: "highGlyphCanvas", name: "highGlyphCanvas", exported: false, typ: ptrType, tag: ""}, {prop: "drops", name: "drops", exported: false, typ: sliceType$2, tag: ""}, {prop: "linkover", name: "linkover", exported: false, typ: $Bool, tag: ""}, {prop: "screenCols", name: "screenCols", exported: false, typ: $Int, tag: ""}, {prop: "minSpeed", name: "minSpeed", exported: false, typ: $Int, tag: ""}, {prop: "maxSpeed", name: "maxSpeed", exported: false, typ: $Int, tag: ""}, {prop: "brightness", name: "brightness", exported: false, typ: $Float64, tag: ""}, {prop: "Clicked", name: "Clicked", exported: true, typ: funcType, tag: ""}]);
	waterDrop.init("main", [{prop: "col", name: "col", exported: false, typ: $Int, tag: ""}, {prop: "row", name: "row", exported: false, typ: $Float64, tag: ""}, {prop: "start", name: "start", exported: false, typ: $Float64, tag: ""}, {prop: "speed", name: "speed", exported: false, typ: $Float64, tag: ""}, {prop: "glyphs", name: "glyphs", exported: false, typ: sliceType$3, tag: ""}, {prop: "spedup", name: "spedup", exported: false, typ: $Bool, tag: ""}, {prop: "created", name: "created", exported: false, typ: Duration, tag: ""}]);
	GlyphCanvas.init("main", [{prop: "jso", name: "jso", exported: false, typ: ptrType$3, tag: ""}, {prop: "glyphs", name: "glyphs", exported: false, typ: mapType$1, tag: ""}]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		...
		githubLink = "http://www.xbed.com.cn";
		level1Cols = 40;
		level2Cols = 60;
		index = 1;
		if ($pkg === $mainPkg) {
