...
#POSIONEDDOMAIN="www.twitter.com twitter.com www.facebook.com"
LOOPTIMES=1
RULEFILENAME=/etc/firewall.user
...
##========================删除旧iptables相关内容 begin==================

#get line_num
#for line_num in $(sudo iptables --line-numbers --list INPUT -t nat | awk '$1=="ill_ip" {print $1}')
for line_num in $(iptables --line-numbers --list INPUT | awk '$2=="ill_ip" {print $1}')
do
...
for line_num in $(iptables --line-numbers --list FORWARD | awk '$2=="ill_ip" {print $1}')
do
  LINES="$line_num $LINES"
done
